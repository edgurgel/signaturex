defmodule SignaturexTest do
  ...
  test "sign with string method" do
    signed_params = sign("key", "secret", "post", "/some/path", %{query: "params", go: "here"})

    assert signed_params == %{
             "auth_version" => "1.0",
             "auth_key" => "key",
             "auth_signature" =>
               "3b237953a5ba6619875cbb2a2d43e8da9ef5824e8a2c689f6284ac85bc1ea0db",
             "auth_timestamp" => 1234
           }
  ...
  test "sign with query params with capitalised letters" do
    signed_params =
      sign("key", "secret", "post", "/some/path", %{"Query" => "params", "Go" => "here"})
  ...
  test "sign with query params on arbitrary" do
    signed_params =
      sign("key", "secret", "post", "/some/path", %{"Go" => "here", "query" => "params"})
  ...
  test "validate invalid signature, auth_signature missing" do
    params =
      %{auth_key: "key", auth_timestamp: "1234", auth_version: "1.0", query: "params", go: "here"}
      |> hash_with_string_keys
